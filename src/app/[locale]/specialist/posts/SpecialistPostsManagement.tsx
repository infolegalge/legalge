...
interface SpecialistPostsManagementProps {
  locale: string;
}

export default function SpecialistPostsManagement({ locale }: SpecialistPostsManagementProps) {
                ...
                <div className="flex items-start justify-between">
                  ...
                  <div className="flex gap-2 ml-4">
                    <Button variant="outline" size="sm" asChild>
                      <Link href={`/${locale}/specialist/posts/${post.slug}`}>
                        <Eye className="h-4 w-4" />
                      </Link>
                    </Button>
                    <Button variant="outline" size="sm" asChild>
                      <Link href={`/${locale}/specialist/posts/${post.id}/edit`}>
